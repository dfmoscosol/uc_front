...
import { getAcreditacionesCapacitacion } from "../../redux/cursos/getAcreditacionesCapacitaciones.slice";
import { SiGoogleclassroom } from "react-icons/si";
import { getAcreditacionesCursos } from "../../redux/cursos/getAcreditacionesCursos.slice";
import OverlayTrigger from "react-bootstrap/OverlayTrigger";
import Tooltip from "react-bootstrap/Tooltip";
import sincaps from "../../assets/images/sin-capacitaciones.png";
import sincursos from "../../assets/images/sin-cursos.png";
      ...
      {isLoadingCap && isLoadingCur ? (
        ...
        <>
          <div className="table-container" style={{ background: "#ffffff", borderRight: "1px solid #d7dfe3", borderLeft: "1px solid #d7dfe3", borderBottom: "1px solid #d7dfe3", borderTop: "2px solid #002856", marginTop: "20px" }} >
            ...
            {acreditaciones_capacitacion.length == 0 ?
              <div className="row justify-content-center mb-4" style={{ maxWidth: "100%" }}>
          ...
          <div className="table-container" style={{ background: "#ffffff", borderRight: "1px solid #d7dfe3", borderLeft: "1px solid #d7dfe3", borderBottom: "1px solid #d7dfe3", borderTop: "2px solid #002856", marginTop: "20px" }} >
            ...
            {acreditaciones_cursos.length == 0 ?
              <div className="row justify-content-center mb-4" style={{ maxWidth: "100%" }}>
                <div className="col-6" style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
                  <img
                    style={{ borderRadius: "8px" }}
