...
import {  getCapacitacionesOpen } from "../../redux/capacitaciones/getOpenCapacitaciones";
import { GiTeamIdea } from "react-icons/gi";
import { GrWorkshop } from "react-icons/gr";
import { SiGoogleclassroom } from "react-icons/si";
import { FaChalkboardTeacher } from "react-icons/fa";
import { BsPersonVideo3 } from "react-icons/bs";
import { MdOutlineAccessTime, MdCalendarMonth, MdPeopleOutline, MdComputer, MdCheckCircle, MdOutlinePending, MdBlock } from "react-icons/md";
...
import { getRutaFromLocalStorage } from "../../services/persistUser.service";
import sinEventos from "../../assets/images/eventos.png";
...
const InscripcionesPage = (): JSX.Element => {
  // local variables
  const { eventos, isLoading } = useAppSelector((state) => state.eventos);
  ...
  useEffect(() => {
    ...
    console.log(getRutaFromLocalStorage())
  }, [dispatch]);
                      ...
                      <div className="card-capacitacion text-center d-flex flex-column h-100" onClick={() => handleOpenEvent(evento)}>
                        ...
                        <div className="card-footer text-muted">
                          {evento.cupos > 0 ? (
                            ...
                            <>
                              {evento.aceptada === null ?
                                <Badge className="badge-bloqueado" bg="primary">
